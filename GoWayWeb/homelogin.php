		...
		<table>
			...
			<td style="text-align: right; padding-right:50px;" width=100%>
				...
				<nav >
						...
						<a href="realsignup.php" id="t">Tour |</a>
						<a href="realsignup.php" id="d">Drive |</a>
						<a href="search1.php" id="s">Search |</a>
						<a href="about1.html" id="a">About Us |</a>
						<a href="realsignup.php" id="y">Your Trips |</a>
						<a href="#" id="h" style="margin-right:90px; color: gray; opacity:0 ;"></a>
			...
			<table>
				<tr>
					<td width=60%>
						...
						<a href="realsignup.php"  class="sign">Sign Up</a> 
					</td>

					<td style="text-align: right; padding-left: 100px; padding-top: 80px;" width=50%>
						<div class="div-login">
							<form name="loginForm" method="POST">
								<center><h1 style="font-family: Century Gothic; font-weight: 100; font-size:20pt">Log In</h1>
								<label id="error" name="err">
								...
								<br><br> 
								<button type="submit" id="lgin" name="sub" onclick="login()">Log In</button>
								<br><br>
